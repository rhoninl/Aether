...
mod tests {
    ...
    #[test]
    fn classify_gltf() {
        assert_eq!(AssetType::from_path(Path::new("model.gltf")), AssetType::Mesh);
    }

    #[test]
    fn classify_glb() {
        assert_eq!(AssetType::from_path(Path::new("model.glb")), AssetType::Mesh);
    }

    #[test]
    fn classify_fbx() {
        assert_eq!(AssetType::from_path(Path::new("model.fbx")), AssetType::Mesh);
    }

    #[test]
    fn classify_obj() {
        assert_eq!(AssetType::from_path(Path::new("model.obj")), AssetType::Mesh);
    }
    ...
    #[test]
    fn classify_bmp() {
        assert_eq!(AssetType::from_path(Path::new("tex.bmp")), AssetType::Texture);
    }

    #[test]
    fn classify_tga() {
        assert_eq!(AssetType::from_path(Path::new("tex.tga")), AssetType::Texture);
    }

    #[test]
    fn classify_hdr() {
        assert_eq!(AssetType::from_path(Path::new("env.hdr")), AssetType::Texture);
    }

    #[test]
    fn classify_wasm() {
        assert_eq!(AssetType::from_path(Path::new("script.wasm")), AssetType::Script);
    }

    #[test]
    fn classify_lua() {
        assert_eq!(AssetType::from_path(Path::new("script.lua")), AssetType::Script);
    }

    #[test]
    fn classify_material() {
        assert_eq!(AssetType::from_path(Path::new("metal.material")), AssetType::Material);
    }

    #[test]
    fn classify_mat() {
        assert_eq!(AssetType::from_path(Path::new("metal.mat")), AssetType::Material);
    }
    ...
    #[test]
    fn classify_flac() {
        assert_eq!(AssetType::from_path(Path::new("sound.flac")), AssetType::Audio);
    }

    #[test]
    fn classify_unknown_extension() {
        assert_eq!(AssetType::from_path(Path::new("readme.txt")), AssetType::Unknown);
    }

    #[test]
    fn classify_no_extension() {
        assert_eq!(AssetType::from_path(Path::new("Makefile")), AssetType::Unknown);
    }
    ...
    #[test]
    fn classify_dotfile() {
        assert_eq!(AssetType::from_path(Path::new(".hidden")), AssetType::Unknown);
    }
